...
class JobTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.job = Job.objects.create(job_name="Java Development Engineer", job_type=JobTypes[0][0], job_city=Cities[1][0], job_requirement="Proficient in Java development")
    ...
    def test_detail(self):
        # Use TestCase.self.client as HTTP Client:
