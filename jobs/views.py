...
# This URL only allows users with user creation permission to access
...
'''
    View that directly returns HTML content (this code has an XSS vulnerability that can be exploited by attackers)
'''
...
class ResumeCreateView(LoginRequiredMixin, CreateView):
    ...
    ### Get default values from URL request parameters
