...
def enter_interview_process(modeladmin, request, queryset):
    ...
    for resume in queryset:
        candidate = Candidate()
        # Copy all attributes from obj object to candidate object:
        ...
        candidate.save()
    messages.add_message(request, messages.INFO, 'Candidate: %s has successfully entered the interview process' % (candidate_names) )


enter_interview_process.short_description = u"Enter Interview Process"
