# Group display fields into four sections: basic info, first round interview, second round interview (professional review), HR interview
default_fieldsets = (
    (None, {'fields': (
    ...
    ('Second Round Interview (Professional Review)', {'fields': ("second_score", ("second_learning_ability", "second_professional_competency"), (
